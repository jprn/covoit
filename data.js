...
window.DemoData = {
  ...
  rides: [
    { id:1, event_id:1, ride_type:'go', depart_at:new Date(Date.now()+10*86400000+(7*60+30)*60000).toISOString(), origin_text:'Lyon Part-Dieu', seats_total:4, driver:'Alice', created_at:new Date().toISOString() },
    { id:2, event_id:1, ride_type:'return', depart_at:new Date(Date.now()+10*86400000+(17*60)*60000).toISOString(), origin_text:'Annecy centre', seats_total:3, driver:'Bruno', created_at:new Date().toISOString() },
  ],
  requests: [
